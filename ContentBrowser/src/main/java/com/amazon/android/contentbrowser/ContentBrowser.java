...
public class ContentBrowser implements IContentBrowser, ICancellableLoad {
    ...
    public List<Action> getContentActionList(Content content) {
        ...
        contentActionList.add(createActionButton(CONTENT_ACTION_RENT,
                R.string.buy_0,
                R.string.buy_1));
    ...
    public void actionTriggered(Activity activity, Content content, int actionId,
        ...
        switch (actionId) {
            ...
            case CONTENT_ACTION_BUY:
                            ...
                            public void onResponse(String response) {
                                AlertDialog.Builder builder =
                                        new AlertDialog.Builder(activity).
                                                setMessage("Check your phone to confirm this payment").
                ...
                break;
            case CONTENT_ACTION_RENT:
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(activity).
                                setMessage("Congratulations! Your playlist was shared on Facebook!").
                                setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();
